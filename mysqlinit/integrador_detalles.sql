...
CREATE TABLE `detalles` (
  ...
  `masa_acumulada` float NOT NULL,
  `temperatura` float NOT NULL,
  `id_orden` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK54rynpp25hl5de0uob42lrc27` (`id_orden`),
  CONSTRAINT `FK54rynpp25hl5de0uob42lrc27` FOREIGN KEY (`id_orden`) REFERENCES `ordenes` (`id`)
